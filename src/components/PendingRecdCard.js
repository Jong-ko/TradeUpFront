  ...
  return (
    <>
      ...
      {fetchedOfferinfo[0].image && <img
        ...
        <p></p>
        <OffereeApproveButton offerorID={props.offerInfo.offerorID} offereeID={props.offerInfo.offereeID} itemID={props.offerInfo.itemID} offerorItemID={props.offerInfo.offerorItemID}/>
        <br></br>
