...
function NewItemForm() {
  ...
  return (
    <div className=" md:h-screen xd:h-none">
      <div className=" gridContainer pt-32  dark:bg-gray-800 dark:text-gray-900 md:flex md:justify-center sm:justify-center sm:flex">
        <div className="pb-32  relative rounded-lg m-5 h-min max-w-md shadow-2xl  bg-gray-50 dark:bg-slate-700 dark:text-sky-50 ">
